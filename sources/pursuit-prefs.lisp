...
(defmethod get-external-def-vals ((module (eql 'sgn))) 
  (list :sgn-path (om-make-pathname :directory (append (pathname-directory (lib-pathname (exist-lib-p "OM-Pursuit"))) '("sgn")) :name "sgn")
        ))
...
(defmethod get-external-icon ((module (eql 'sge))) (and (exist-lib-p "OM-Pursuit") (list 01 (exist-lib-p "OM-Pursuit"))))
...
(defmethod get-external-def-vals ((module (eql 'sge))) 
  (list :sge-path (om-make-pathname :directory (append (pathname-directory (lib-pathname (exist-lib-p "OM-Pursuit"))) '("sge")) :name "sge")
        ))
...
(defmethod get-external-def-vals ((module (eql 'mdc))) 
  (list :mdc-path (om-make-pathname :directory (append (pathname-directory (lib-pathname (exist-lib-p "OM-Pursuit"))) '("mdc")) :name "mdc")
        ))
